...
# dois parâmetros são necessários para criar uma tupla nomeada: um nome de classe e uma lista de nomes de campos
# especificados como um interável de strings ou uma única string delimitada por espaços
...
# _make() permite instanciar uma tupla nomeada a partir de um interável
